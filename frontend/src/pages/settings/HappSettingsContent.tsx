            ...
            children: (
              <>
                ...
                <SettingListItem
                  ...
                  description={
                    allSetting.subRoutingSource === 'custom' || !allSetting.subRoutingSource
                ...
                {(!allSetting.subRoutingSource || allSetting.subRoutingSource === 'custom') && (
                  <>
                    <SettingListItem
                      paddings="small"
                      ...
                      <Space orientation="horizontal" style={{ width: '100%' }}>
                        <Select
                          ...
                          options={[
                            ...
                            {
                              value: 'china-direct',
                              label: t('pages.settings.subHappPresetChina'),
                            },
