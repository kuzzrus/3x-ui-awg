...
// The form must reject what cannot apply or be received: jc/jmin/jmax past uint32
// (device/uapi.go), S1-S3 past amneziawg-go's 1700-byte iOS receive buffer, S4 past 32 (MTU headroom).
