...
export const AllSettingSchema = z.object({
  ...
  frontProxyCertMode: z.string(),
  frontProxyDecoyMode: z.string(),
  frontProxyDecoyProxyURL: z.string(),
  frontProxyDecoyTemplate: z.string(),
  frontProxyDomain: z.string(),
  frontProxyEmail: z.string(),
...
export const InboundSchema = z.object({
  ...
  port: z.number().int().min(0).max(65535),
  protocol: z.enum(['vmess', 'vless', 'trojan', 'shadowsocks', 'wireguard', 'hysteria', 'http', 'mixed', 'tunnel', 'tun', 'mtproto', 'amneziawg', 'naiveproxy', 'tproxy', 'tuic']),
  remark: z.string(),
  settings: z.unknown(),
  shareAddr: z.string(),
