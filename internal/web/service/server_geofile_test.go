...
func TestStandardGeodataSources(t *testing.T) {
	want := []GeodataSource{
		...
		{URL: "https://github.com/hydraponique/roscomvpn-geoip/releases/latest/download/geoip.dat", File: "geoip_rosip.dat"},
		{URL: "https://github.com/runetfreedom/russia-v2ray-rules-dat/releases/latest/download/geoip.dat", File: "geoip_runet.dat"},
		...
		{URL: "https://github.com/runetfreedom/russia-v2ray-rules-dat/releases/latest/download/geosite.dat", File: "geosite_runet.dat"},
	}
