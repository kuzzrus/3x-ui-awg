...
type geofileEntry struct {
	...
	Asset    string
	FileName string
	// DigestExt overrides the sidecar checksum's file extension for a repo
	// that doesn't follow Loyalsoldier/chocolate4u/runetfreedom's own
	// ".sha256sum" convention; empty means ".sha256sum".
	DigestExt string
}

func (entry geofileEntry) digestExt() string {
	if entry.DigestExt != "" {
		return entry.DigestExt
	}
	return ".sha256sum"
}

var geofileAllowlist = map[string]geofileEntry{
	"geoip.dat":          {Repo: "https://github.com/Loyalsoldier/v2ray-rules-dat", Asset: "geoip.dat", FileName: "geoip.dat"},
	"geosite.dat":        {Repo: "https://github.com/Loyalsoldier/v2ray-rules-dat", Asset: "geosite.dat", FileName: "geosite.dat"},
	"geoip_IR.dat":       {Repo: "https://github.com/chocolate4u/Iran-v2ray-rules", Asset: "geoip.dat", FileName: "geoip_IR.dat"},
	"geosite_IR.dat":     {Repo: "https://github.com/chocolate4u/Iran-v2ray-rules", Asset: "geosite.dat", FileName: "geosite_IR.dat"},
	"geoip_runet.dat":    {Repo: "https://github.com/runetfreedom/russia-v2ray-rules-dat", Asset: "geoip.dat", FileName: "geoip_runet.dat"},
	"geosite_runet.dat":  {Repo: "https://github.com/runetfreedom/russia-v2ray-rules-dat", Asset: "geosite.dat", FileName: "geosite_runet.dat"},
	"geoip_rosip.dat":    {Repo: "https://github.com/hydraponique/roscomvpn-geoip", Asset: "geoip.dat", FileName: "geoip_rosip.dat", DigestExt: ".sha256"},
	"geosite_roscom.dat": {Repo: "https://github.com/hydraponique/roscomvpn-geosite", Asset: "geosite.dat", FileName: "geosite_roscom.dat", DigestExt: ".sha256"},
}
...
func (s *ServerService) stageGeofile(client *http.Client, entry geofileEntry, tag, destPath, stagePath string) (bool, error) {
	...
	want, err := s.fetchGeofileDigest(client, assetURL+entry.digestExt(), entry.Asset)
	if err != nil {
		return false, err
	}
	if got := hex.EncodeToString(hasher.Sum(nil)); !strings.EqualFold(got, want) {
