...
func TestValidatedObfuscationAlwaysApplies(t *testing.T) {
	...
	base := amneziawg.Obfuscation20{Jc: 4, Jmin: 40, Jmax: 70, S1: 20, S2: 30, S3: 20, S4: 20}

	cases := []struct {
		name string
		mut  func(*amneziawg.Obfuscation20)
	}{
		{"generated defaults", func(o *amneziawg.Obfuscation20) { *o = amneziawg.GenerateObfuscation20("default") }},
		{"S1 over uint16", func(o *amneziawg.Obfuscation20) { o.S1 = 70000 }},
		{"S2 over uint16", func(o *amneziawg.Obfuscation20) { o.S2 = 70000 }},
		{"negative Jc", func(o *amneziawg.Obfuscation20) { o.Jc = -1 }},
		{"negative Jmin and Jmax", func(o *amneziawg.Obfuscation20) { o.Jmin, o.Jmax = -5, -1 }},
		{"Jc over uint32", func(o *amneziawg.Obfuscation20) { o.Jc = 5000000000 }},
		{"I1 unknown tag", func(o *amneziawg.Obfuscation20) { o.I1 = "<rand 100>" }},
		{"I1 missing close", func(o *amneziawg.Obfuscation20) { o.I1 = "<r 100" }},
		{"I1 empty tag", func(o *amneziawg.Obfuscation20) { o.I1 = "<>" }},
		// The specs validateObfChain deliberately accepts must really apply.
		{"I1 chained tags", func(o *amneziawg.Obfuscation20) { o.I1 = "<b ff00><r 10>" }},
		{"I1 valueless tag", func(o *amneziawg.Obfuscation20) { o.I1 = "<t><rc 5>" }},
		{"I1 no tags at all", func(o *amneziawg.Obfuscation20) { o.I1 = "plain text" }},
		{"H ranges overlap", func(o *amneziawg.Obfuscation20) { o.H1, o.H2 = "100-200", "150-300" }},
		{"H1 equals the blank H3 default", func(o *amneziawg.Obfuscation20) { o.H1 = "3" }},
		{"H1-H4 = WireGuard's 1-4", func(o *amneziawg.Obfuscation20) { o.H1, o.H2, o.H3, o.H4 = "1", "2", "3", "4" }},
		// Separate cases: 1552+56 == 1608, so both maxima together trip the S1/S2 size rule.
		{"S1 and S3 at the 1700-byte bound", func(o *amneziawg.Obfuscation20) { o.S1, o.S3 = 1552, 1636 }},
		{"S2 at the 1700-byte bound", func(o *amneziawg.Obfuscation20) { o.S2 = 1608 }},
		{"Amnezia Premium set", func(o *amneziawg.Obfuscation20) {
...
func TestBuildUAPIConfigClearedHeaderProtectionKeyIsSentAsZero(t *testing.T) {
	...
	inst := amneziawg.Instance{
		PrivateKey:  priv,
		Obfuscation: amneziawg.Obfuscation20{S1: 20, S2: 20, S3: 20, S4: 20},
	}
