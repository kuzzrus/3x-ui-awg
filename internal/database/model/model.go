...
type Inbound struct {
	...
	Protocol          Protocol `json:"protocol" form:"protocol" validate:"required,oneof=vmess vless trojan shadowsocks wireguard hysteria http mixed tunnel tun mtproto amneziawg naiveproxy tproxy tuic" example:"vless"`
