...
func TestValidateObfuscationRejectsOutOfRangeJunkAndPadding(t *testing.T) {
	...
	tests := []struct {
		...
		{"S1 init over 1700 bytes", func(o *Obfuscation20) { o.S1 = 1553 }},
		{"S2 response over 1700 bytes", func(o *Obfuscation20) { o.S2 = 1609 }},
	...
	for _, s := range [][2]int{{1552, 30}, {20, 1608}, {284, 659}} {
		if err := ValidateObfuscation(Obfuscation20{Jc: 4, Jmin: 40, Jmax: 70, S1: s[0], S2: s[1], S3: 20, S4: 20}); err != nil {
